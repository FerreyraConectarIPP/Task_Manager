...
def update_incident(
    ...
    detected_at=None, responsible_id=None, status=None, subtype=None,
    ...
    if subtype is not None: fields.append("subtype=?"); values.append(subtype)
